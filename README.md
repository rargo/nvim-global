...
Support more than one tag files. It's userful to find symbol that defined in other projects, for example, symbols defined in librarys, kernel header files
